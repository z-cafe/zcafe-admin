...
const addMemberUrl = 'https://script.google.com/macros/s/AKfycbwXXXXX/exec'; // 替換為會員資料試算表的新增會員 App Script URL
const queryUrl = 'https://script.google.com/macros/s/AKfycbwXXXXX/exec';     // 替換為會員資料試算表的查詢會員 App Script URL

// 點數調整功能 使用另一個 Excel：
const adjustPointsUrl = 'https://script.google.com/macros/s/AKfycbxxxxxx/exec'; // 替換為點數與扣款紀錄試算表的 App Script URL
